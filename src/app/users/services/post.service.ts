...
export class PostService {
  ...
  saveImagesDrive(images: FormData): Observable<string[]> {
    return this.http.post<string[]>(
      `${this.urlAPI}/drive/uploadImages`,
      images
    );
  }
  ...
  createPostLostPet(postLostPet: ILossPostSerialization): Observable<void> {
    return this.http.post<void>(
      `${this.urlAPI}/posts/createPostLostPet`,
      postLostPet
    );
  }

  createPostAdoptionPet(
    postAdoptionPet: IAdoptionPostSerialization
  ): Observable<void> {
    return this.http.post<void>(
      `${this.urlAPI}/posts/createPostPetAdoption`,
      postAdoptionPet
    );
  }
